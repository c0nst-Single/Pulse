...
document.querySelector('.prev').addEventListener('click', function () {  //стрелка для пролистыванимя
  slider.goTo('prev');
});
document.querySelector('.next').addEventListener('click', function () {  //стрелка для пролистыванимя
  slider.goTo('next');
